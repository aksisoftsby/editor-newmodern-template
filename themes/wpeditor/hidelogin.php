...
define("NEW_LOGIN_SLUG", "nkri");

class PluginHideLogin
{
    ...
    public function __construct()
    {
        ...
        add_action('wp_loaded', array($this, 'plugins_loaded'));
    ...
    public function plugins_loaded()
    {
        ...
        /*
        echo untrailingslashit($request['path']);
        echo home_url($this->new_login_slug(), 'relative');
        exit;
        */
