...
if (!class_exists('KIA_Subtitle')) :
    ...
    class KIA_Subtitle
    {
        ...
        {
            require_once __DIR__ . "/subtitle-form.php";
        ...
        public function load_scripts($hook)
        {
            ...
            wp_register_script(
                'kia_subtitle',
                get_template_directory_uri() . "/js/subtitle-load.js",
                # plugins_url('js/subtitle' . $suffix . '.js', __FILE__), 
                array('jquery'),
                $this->version,
                true
            );
...
<?php   }
        ...
        public function enqueue_assets($hook)
        {
            ...
            if (self::is_enabled_for_post_type($current_screen->post_type) && post_type_supports($current_screen->post_type, 'custom-fields')) {
                wp_enqueue_script(
                    'kia-subtitle-gutenberg-sidebar',
                    get_template_directory_uri() . "/js/subtitle-asset.js",
...
add_action("wp_loaded", 'KIA_subtitle');
