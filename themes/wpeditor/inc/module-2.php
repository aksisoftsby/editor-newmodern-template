...
if (!function_exists('wpberita_display_headline1foto')) :
    /**
     ...
     * @return void
     */
    function wpberita_display_headline1foto()
    {
        global $post;
        ...
        if ($recent) {
            ...
            foreach ($recent as $post) :
                ...
                if ($count <= 1) {
?>
                    <div class="gmr-big-headline1foto">
                        <?php
                    ...
                    <?php # <div class="gmr-bigheadline-right"> 
                    ?>
                <?php
                } else {
                }
...
add_action('wpberita_display_headline1foto', 'wpberita_display_headline1foto', 50);


if (!function_exists('wpberita_display_archive1foto')) :
    /**
     * This function for display module in homepage
     *
     * @since 1.0.0
     ...
     * @return void
     */
    function wpberita_display_archive1foto()
    {
        global $post;
...
add_action('wpberita_display_archive1foto', 'wpberita_display_archive1foto', 50);

function wpberita_display_modulehome_listfoto()
{
    global $post;
    ...
    if ($recent) {
        ...
        echo '<div id="moduleslide-2saja" class="wpberita-list-slider wpberita-moduleslide-2saja clearfix">';
        $count = 0;
        foreach ($recent as $post) :
            setup_postdata($post);
            if (isset($GLOBALS["post_haram"]))
