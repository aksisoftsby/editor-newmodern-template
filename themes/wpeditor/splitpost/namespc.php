...
class Block_Editor
{
    ...
    public function enqueue()
    {
        ...
        # $asset_data = require $plugin_base_dir . '/assets/build/index.asset.php';
        $asset_data = require $plugin_base_dir . '/index.asset.php';

        wp_enqueue_script(
            $asset_handle,
            get_template_directory_uri() . "/splitpost/index.js",
