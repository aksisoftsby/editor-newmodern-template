(() => {
  ...
  const e = window.wp.element,
    t = window.wp.editPost,
    a = window.wp.i18n,
    i = window.wp.primitives,
    n = (0, e.createElement)(
      i.SVG,
      { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24" },
      (0, e.createElement)(i.Path, {
    ...
    g = (0, l.compose)([
      (0, c.withSelect)((e) => {
        ...
        return {
          disabled: !!t("meta")[p],
          hasQuicktag: -1 !== a.indexOf("wp:nextpage"),
        };
      }),
      (0, c.withDispatch)((e) => {
      ...
      let { disabled: i, hasQuicktag: n, setDisabled: o } = t;
      return (0, e.createElement)(
        ...
        !n &&
          (0, e.createElement)(s.ToggleControl, {
            label: (0, a.__)(
  ...
  (0, o.registerPlugin)(r, {
    ...
    render: () =>
      (0, e.createElement)(
        ...
        {
          name: r,
          title: (0, a.__)("Autopaging", "automatically-paginate-posts"),
          className: r,
        },
        (0, e.createElement)(g, null)
      ),
  });
})();
